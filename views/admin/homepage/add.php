...
<head>
    ...
    <title>Add Homepage Content - School Management System</title>
    ...
    <div class="container-fluid mt-4">
        ...
        <div class="row mb-4">
            <div class="col-12">
                ...
                <h2><i class="fas fa-plus"></i> Add Homepage Content</h2>
            </div>
        </div>
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="/admin/homepage/add">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="image_path" name="image_path" placeholder="e.g., /uploads/images/hero.jpg">
                            </div>
